...
import (
	...
	app "github.com/kava-labs/cosmos-sdk-paychan/exampleapp"
	"github.com/kava-labs/cosmos-sdk-paychan/paychan"
	paychanClient "github.com/kava-labs/cosmos-sdk-paychan/paychan/client"
	paychanRest "github.com/kava-labs/cosmos-sdk-paychan/paychan/client/rest"
)
...
func main() {
	...
	mc := []sdk.ModuleClient{
		...
		paychanClient.NewModuleClient(paychan.StoreKey, cdc),
	}

	rootCmd := &cobra.Command{
		Use:   "examplecli",
		Short: "Command line interface for interacting with exampled",
	}
	...
	// Add flags and prefix all env exposed with EA
	executor := cli.PrepareMainCmd(rootCmd, "EA", app.DefaultCLIHome)
...
func registerRoutes(rs *lcd.RestServer) {
	...
	paychanRest.RegisterRoutes(rs.CliCtx, rs.Mux, rs.Cdc) // TODO write
}
